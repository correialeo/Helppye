...
export const SecondaryButton = forwardRef<HTMLButtonElement, SecondaryButtonProps>(
  ({ className, fullWidth, children, ...props }, ref) => (
    <button
      ...
      type="button"
      className={cx(
        "inline-flex items-center justify-center gap-2 rounded-lg border border-white/15 bg-surface-raised/60 px-4 py-2.5 text-sm font-medium text-neutral-100 transition-colors duration-150",
